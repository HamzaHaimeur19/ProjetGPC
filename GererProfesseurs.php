...
unset($_SESSION["SuppProf"]);
  ...
  <nav class="navbar navbar-dark bg-dark" style="background-color:yellow ;">
      ...
      <?php
       ...
       $stm=$pdo->prepare('select p.Id_prof, p.nom, p.prenom, p.cin, p.adresse, p.telephone, p.email, p.date_recrutement, d.nom_department from professeur p, department d where d.id_department=p.id_department');
